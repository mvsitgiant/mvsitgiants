...
const OurServices = () => {
  ...
  return (
    <div className="conplr   lg:p-5">
      <div className="my-5">
        <h1 className="text-4xl uppercase font-poppinsh font-semibold">
          Our Services
        </h1>
      </div>
        ...
        <div className="lg:border-r-2 w-full lg:w-[30%] pt-5  flex flex-col justify-between">
          <div>
            <p className="font-normal py-3 pr-3 text-navfontcolor ">
              Driving Growth Through Digital Channels Maximize your online
              presence and reach your target audience with our comprehensive
              digital marketing services. We combine data-driven strategies with
              creative solutions to boost your brand awareness, drive traffic,
              ...
              <div key={service.id} className="p-0 lg:p-2  ">
                <div
                  ...
                  style={{
                    background:
                      index === 0 &&
                      `linear-gradient(to bottom, #FFE2EA, #C5DCFF,#C5DCFF)`,
                  }}
                >
                  <div className="">
                    ...
                    <p className="font-normal text-sm pl-3 pr-2 text-navfontcolor">
                      Your website is often the first impression customers have
                      of your business. We specialize in creating responsive,
